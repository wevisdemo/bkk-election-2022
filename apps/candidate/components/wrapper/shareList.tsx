...
import iWebsiteW from '../../static/icons/socials/website.svg';
...
import iWebsiteB from '../../static/icons/socials/black/website.svg';
  ...
  return (
    <div className="flex items-center px-[30px] py-[16px] m-auto justify-center">
      ...
      <div className="space-x-[10px] flex">
        <img src={white ? iWebsiteW.src : iWebsiteB.src} alt="i-website" />
