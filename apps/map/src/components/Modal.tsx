		...
		>
			...
			>
				...
				{imageUrl && (
					...
					>
						<div
							class={`absolute w-full h-1/2 bottom-0 lg:h-full lg:w-1/2 lg:right-0 bg-gradient-to-t lg:bg-gradient-to-l z-10 from-black to-black/0 pointer-events-none`}
						/>
					</div>
				)}
